...
public class MomentActivity extends BaseMvpActivity<MomentPresenter, MomentModel> implements MomentContract.MomentView {
...
//                            mPresenter.loadMomentList();
    ...
    protected void initMvpView(Bundle savedInstanceState) {
        ...
        rvMoment = findViewById(R.id.rv_momentlist);
        ...
        rvMoment.setLayoutManager(new MyContentLinearLayoutManager(this));
        momentRefesh = findViewById(R.id.momentRefresh);
        ...
        adapter.setOnItemClickListener(new BaseQuickAdapter.OnItemClickListener() {
            ...
            public void onItemClick(BaseQuickAdapter adapter, View view, int position) {
                ...
                MomentBean.ListBean listBean = listBeans.get(position);
                Intent intent = new Intent(MomentActivity.this, MomentDetailActivity.class);
