...
import cn.flyaudio.flycodelibrary.server.OkDownload;
...
public class DownloadTask implements Runnable {
    ...
    private static final int HTTP_FILENOTFOUND_CODE = 404;
    private static final int HTTP_SERVERERROR_CODE = 500;

    public Progress progress;
    public Map<Object, AbstractDownloadListener> listeners;
    ...
    public DownloadTask register(AbstractDownloadListener listener) {
        if (listener != null) {
    ...
    public void unRegister(AbstractDownloadListener listener) {
    ...
    public void run() {
        ...
        if (code == HTTP_FILENOTFOUND_CODE || code >= HTTP_SERVERERROR_CODE) {
    ...
    private void postOnStart(final Progress progress) {
        ...
        HttpUtils.runOnUiThread(new Runnable() {
            @Override
            public void run() {
                for (AbstractDownloadListener listener : listeners.values()) {
