...
import cn.flyaudio.flycodelibrary.utils.FileUtils;
import cn.flyaudio.flycodelibrary.utils.TimeUtils;

import static cn.flyaudio.flycodelibrary.TestConfig.FILE_SEP;
import static cn.flyaudio.flycodelibrary.TestConfig.PATH_FILE;
import static cn.flyaudio.flycodelibrary.TestConfig.PATH_TEMP;
...
////        assertTrue(FileUtils.deleteFile(PATH_FILE + "new File"));
    ...
    public void deleteFiles(){
        FileUtils.deleteDir(PATH_FILE+"test"+FILE_SEP);
    }

    @Test
    public void deleteAllInDir(){
        FileUtils.deleteAllInDir(PATH_FILE);
    }

    @Test
    public void getFileCharsetSimple() {
        System.out.println(FileUtils.getFileCharsetSimple(PATH_FILE+"test.txt"));
    }
